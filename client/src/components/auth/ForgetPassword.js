        ...
        <div style={{ marginTop: "3rem" }} className="row">
          ...
          <Container maxWidth="sm">
            ...
            >
              ...
              <Typography className={'custom-txt-h'} component="h1" variant="h5">
                Forget Password
              </Typography>
            </div>
            <div>
                <p className={'custom-txt-p'} style={{textAlign: 'center', color: 'grey'}}>
                    Enter your email to receive secure code to reset your password. 
                    Please make a note that your secure code will exipre in 5 mins.
                </p>
            </div>
